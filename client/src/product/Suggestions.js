                  ...
                  <CardContent className={classes.content}>
                    ...
                    <Link to={'/shops/'+item.shop._id}>
                      <Typography type="subheading" className={classes.subheading}>
                        <Icon className={classes.icon}>Повернутися до магазину</Icon> {item.shop.name}
                      </Typography>
                    </Link>
                    <Typography component="p" className={classes.date}>
                        Додано {(new Date(item.created)).toDateString()}
                    </Typography>
                  </CardContent>
                  <div className={classes.controls}>
                    <Typography type="subheading" component="h3" className={classes.price} color="primary">{item.price},00 грн</Typography>
