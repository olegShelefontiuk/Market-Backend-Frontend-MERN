            ...
            <Grid item xs={6} sm={6}>
                <Card className={classes.card}>
                    <CardContent>
                        ...
                        <TextField id="name" label="Назва магазину" className={classes.textField} value={values.name} onChange={handleChange('name')} margin="normal"/><br/>
                        <TextField
                    ...
                    <CardActions>
                        <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Оновити</Button>
                    </CardActions>
                </Card>
            </Grid>
            <Grid item xs={6} sm={6}>
